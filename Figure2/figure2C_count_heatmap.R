...
########################
# R script for figure 2C: Cell counts heatmap
########################
...
######################
# R script for figure  2 C: Heatmap shows well-level cell counts in different plate
######################
...
dat <- read_csv("raw_medians_fig2C.csv")
