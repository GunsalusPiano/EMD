...
reps.dmso = read_csv("control_data_fig4C.csv")
reps.trt = read_csv("treatment_data_fig4C.csv")
...
# DMSO replicates
reps.dmso1 = read_csv("control_replicate_test_allpanels_fig4D.csv")
# Treatment replicates
reps.trt1 = read_csv("treatment_replicate_test_allpanels_fig4D.csv")
...
meds.ks = aggregate(reps.dmso1[, 7], list(reps.dmso1$feature), mean, na.rm = TRUE)
meds.emd = aggregate(reps.dmso1[, 9], list(reps.dmso1$feature), mean, na.rm = TRUE)
...
meds.ks = aggregate(reps.trt1[, 7], list(reps.trt1$feature), mean, na.rm = TRUE)
meds.emd = aggregate(reps.trt1[, 9], list(reps.trt1$feature), mean, na.rm = TRUE)
